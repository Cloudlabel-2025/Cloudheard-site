  ...
  return (
    <>
      ...
      <div className="container-fluid">
        ...
        >
          <h3 className="display-5 mb-2">Cloud Integration Services</h3>
        ...
        <div className="m-3 p-3 row rounded shadow-lg">
          ...
          <div className="col-xl-6 col-md-6 col-sm-12 p-5 animated slideInLeft">
            <ul className="list-unstyled ps-3">
              <li>
                <strong>Our Integration Framework:</strong>
              </li>
              <li>
              ...
              <li>
                <i className="bi bi-check text-dark me-2"></i>
                Go-Live → Smooth, structured transition into production.</li>
              <li>
                <i className="bi bi-check text-dark me-2"></i>
