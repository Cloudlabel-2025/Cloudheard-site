...
function Header() {
  ...
  return (
    <div
      className="container-fluid fixed-top px-0 wow fadeIn mt-4"
      data-wow-delay="0.1s"
    >
            ...
            <div className="nav-item dropdown">
              ...
              <div className="dropdown-menu border-light m-0">
                ...
                <Link
                  ...
                  className={`dropdown-item ${
                    pathname === "/expertise/oracle-integration-cloud"
                      ? "active"
                      : ""
                  }`}
                >
                ...
                <Link
                  ...
                  className={`dropdown-item ${
                    pathname === "/expertise/fusion-data-intelligence"
                      ? "active"
                      : ""
                  }`}
                >
                ...
                <Link
                  ...
                  className={`dropdown-item ${
                    pathname === "/expertise/version-control-system"
                      ? "active"
                      : ""
                  }`}
                >
                ...
                <Link
                  ...
                  className={`dropdown-item ${
                    pathname === "/expertise/application-development"
                      ? "active"
                      : ""
                  }`}
                >
                ...
                <Link
                  ...
                  className={`dropdown-item ${
                    pathname === "/expertise/oracle-subscription"
                      ? "active"
                      : ""
                  }`}
                >
            ...
            <div className="nav-item dropdown">
              ...
              <div className="dropdown-menu border-light m-0">
                ...
                <Link
                  ...
                  className={`dropdown-item ${
                    pathname === "/services/implementation-services"
                      ? "active"
                      : ""
                  }`}
                >
                ...
                <Link
                  ...
                  className={`dropdown-item ${
                    pathname === "/services/integration-services"
                      ? "active"
                      : ""
                  }`}
                >
