        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            >
              ...
              <p className="mb-4">
                At Cloudheard, we bring deep domain expertise in Oracle
                applications to empower organisations on their digital journey.
                With years of experience, we have successfully guided clients
                through:
              </p>
              ...
              <div className="row g-4 align-items-center">
                  ...
                  <div className="row g-4">
                    ...
                    >
                      <div className="feature-box border rounded p-4">
                        ...
                        <p className="mb-3">
                          Simplifying enterprise processes with intelligent
                          financials, procurement, and project management.
                        </p>
                    ...
                    >
                      <div className="feature-box border rounded p-4">
                        ...
                        <p className="mb-3">
                          Streamlining human capital management, payroll,
                ...
                <div className="col-md-6 wow fadeIn" data-wow-delay="0.7s">
                  <div className="feature-box border rounded p-4">
                    ...
                    <p className="mb-3">
                      Helping businesses modernise operations by moving from
                      legacy systems to Oracle Cloud Infrastructure.
                    </p>
                    <a
                  ...
                  <div className="col-12 mt-4 wow fadeIn" data-wow-delay="0.9s">
                    <div className="feature-box border rounded p-4">
                      ...
                      <p className="mb-3">
                        Unlocking revenue opportunities with advanced
        ...
        <div className="container">
          ...
          >
            ...
            <h1 className="display-11 mb-5">
              Deliver comprehensive Oracle Cloud solutions that streamline
              operations, enhance workforce management, and simplify business
              processes.
            </h1>
          </div>
          {/* Tabs */}
              ...
              >
                ...
                >
                  ...
                  <p className="d-inline-block text-primary fw-semi-bold py-1 px-2">
                    Have a query in your mind? Connect with us by filling out
                    the form below!
                  </p>
                </div>
